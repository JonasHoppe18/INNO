...
// Verbatim extraction from InboxSplitView.jsx (Task 3, Plan 2).
// Default sort is "newest_activity" (Newest first) everywhere, including the
// Inbox/needs_attention queue — per direct feedback that Newest, not
// oldest-waiting-customer, should be the out-of-the-box ordering. Oldest
// waiting customer is still available as an explicit dropdown choice.
