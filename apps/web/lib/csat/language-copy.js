export const CUSTOMER_SATISFACTION_LANGUAGE_COPY = {
  en: {
    ...
    lowLabel: "Very poor",
    highLabel: "Excellent",
    instruction: "Click a number to share your feedback.",
  ...
  da: {
    ...
    instruction: "Klik på et tal for at dele din feedback.",
  ...
  de: {
    ...
    instruction: "Klicke auf eine Zahl, um dein Feedback zu teilen.",
  ...
  es: {
    ...
    lowLabel: "Muy mala",
    highLabel: "Excelente",
    instruction: "Haz clic en un número para compartir tus comentarios.",
  ...
  fr: {
    ...
    instruction: "Cliquez sur un chiffre pour partager votre avis.",
  ...
  sv: {
    ...
    highLabel: "Utmärkt",
    instruction: "Klicka på en siffra för att dela din feedback.",
  ...
  no: {
    ...
    highLabel: "Utmerket",
    instruction: "Klikk på et tall for å dele tilbakemeldingen din.",
