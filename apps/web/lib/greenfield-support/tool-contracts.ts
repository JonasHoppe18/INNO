...
export const GREENFIELD_TOOL_DEFINITIONS: StrictToolDefinition[] = [
  ...
  readOnly("get_tracking", "Read current shipment tracking for an order from live shipping/commerce data.", { order_id: stringProperty("The order number or order ID.") }),
