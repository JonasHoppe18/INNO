...
// memory). This must stay the very first statement in POST — before auth, before any
// provider fetch, before embedding, before the agent_knowledge insert below — so this
// writer can never run.
