...
export default function CustomerSatisfactionSurveyPage({ params }) {
  ...
  useEffect(() => {
    let active = true;
    fetch(`/api/csat/survey/${encodeURIComponent(params?.token || "")}`, { cache: "no-store" })
      .then(async (response) => {
