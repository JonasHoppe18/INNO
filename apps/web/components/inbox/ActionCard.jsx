            ...
            <div className="space-y-5">
              ...
              {showAppliedChange ? (
                <div className="space-y-2">
                  <div className="text-sm font-medium text-muted-foreground">{appliedChangeLabel}</div>
                  <div className="space-y-0.5 text-base font-medium text-foreground">
      ...
      <div className="w-full max-w-[520px] overflow-hidden rounded-lg border border-border bg-card shadow-sm">
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="text-xs text-muted-foreground">Executing action...</div>
          </div>
        </div>
      </div>
    );
