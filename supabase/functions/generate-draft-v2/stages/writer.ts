...
- FAKTURA/kvittering (resend_confirmation_or_invoice): Skriv KUN som om fakturaen er sendt (datid) hvis actionResult bekræfter at faktura-/resend-handlingen ER udført. Er den ikke bekræftet udført, brug neutral formulering der IKKE lover fremtidig levering (fx "Jeg kan ikke sende fakturaen direkte herfra, men sagen bliver håndteret manuelt" eller "Kan du sende dit ordrenummer, så vi kan hjælpe med fakturaen?") — lov aldrig at den allerede er sendt eller videresendt, og lov aldrig at den vil blive sendt/tilsendt. 1-2 sætninger.
...
- FAKTURA-REGEL: Når action er "resend_confirmation_or_invoice" OG actionResult bekræfter at handlingen ER udført — skriv da som om fakturaen er sendt (datid), 1-2 sætninger + lukning. Er handlingen ikke bekræftet udført, brug neutral formulering der IKKE lover fremtidig levering (fx "Jeg kan ikke sende fakturaen direkte herfra, men sagen bliver håndteret manuelt") — lov aldrig at fakturaen allerede er sendt eller videresendt, og lov aldrig at den vil blive sendt/tilsendt.
